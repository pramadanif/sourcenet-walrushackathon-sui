...
const GridDistortion: React.FC<GridDistortionProps> = ({
  ...
  useEffect(() => {
    if (!containerRef.current || !mountRef.current || !isMounted) return;
  ...
  }, [grid, mouse, strength, relaxation, imageSrc, isMounted]);
  ...
  return (
    ...
    >
      ...
      {error && (
        <div
          className="absolute inset-0 flex items-center justify-center bg-black/20 text-gray-500 text-sm"
          style={{ zIndex: 2 }}
        >
          {error}
        </div>
